            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        ...
                        <p class="text-primary"><b>Registered technicians details</b></p>

                    </div>

                    <div class="col-4">

                        <a class = "btn btn-primary"  href="{{url('/technicianDetails')}}" role = "button">View</a>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        ...
                        <p class="text-primary"><b>Verify technicians details</b></p>

                    </div>

                    <div class="col-4">

                        <a class = "btn btn-primary"  href="{{url('/VerifyTechDetails')}}" role = "button">View</a>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        ...
                        <p class="text-primary"><b>Customers Details</b></p>

                    </div>

                    <div class="col-4">

                        <a class = "btn btn-primary"  href="{{url('/customerDetails')}}" role = "button">View</a>
                    </div>
