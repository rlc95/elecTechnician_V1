	...
	<div class="container">
			...
			<div class="card">
				...
				<div class="card-header">
					...
					<h1 class="lead">Register Customer</h1> 
				...
				<div class="card-body">
								...
								{{csrf_field()}}
									...
									<div class="container">
											...
											<div class="form-row">
												<div class="form-group col-md-6">
													...
													<input type="text" class="form-control" id="inputBD" name="inputBD" placeholder="dd/mm/yyyy" value="{{ old ('inputBD') }}">
													<span class="text-danger">@error('inputBD'){{$message}}@enderror</span>
												</div>
	
												<div class="form-group col-md-6">
													<label for="inputOne">Gender</label>
													<select id="inputOne" name="inputOne" class="form-control">
														<option selected>choose</option>
														<option >Male</option>
														<option >Female</option>				
													</select>
													<span class="text-danger">@error('inputOne'){{$message}}@enderror</span>
												</div>
											</div>
									</div>
									...
									<a href="{{url('/customer/login')}}" >I already have an account</a>
								</form>
