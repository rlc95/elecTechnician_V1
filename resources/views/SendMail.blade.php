    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="text-success"><b>Request Message Sent Successfully</b></p>
                <hr class="display-4">
                <p class="text-info">you will get repairing service immediately</p>
                <hr class="display-4">
                <p style="color: chocolate;">Thank You for you join with elecTechnician___Come back!</p>
