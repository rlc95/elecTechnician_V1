...
<body>
    ...
    <div class="container-fluid">
		<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
            ...
            <h1 style="margin-right: 450px; color: aliceblue;">Contact Us</h1>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="text-info">Email         |  ranganalakch@gmail.com</p>
                <p class="text-success">Mobile Number |  0768444917 </p>
